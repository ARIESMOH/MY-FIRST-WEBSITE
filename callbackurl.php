<?php
#This is the url that gets transaction callback from safaricom in real time so that you can diagnose data from the transaction or keep records
...
$callbackData=json_decode($callbackJSONData); #decodes the transaction data received from safaricom
