...
<form action="./stkpush" method="POST" >
  <div class="container">
    ...
    <input type="text" name="amount" placeholder="Enter Amount" title="Only numbers/digits" type="number" pattern="[0-9]+" required>
    
    <label for="psw"><b>Phone Number</b></label>
    <input type="text" name="phone_number" placeholder="Enter Phone Number"  title="Only numbers/digits" type="number" pattern="[0-9]+"  required >
  ...
  <div class="container signin">
    <p>Already Paid? <a href="/confirm_pay.php">Confirm Payment</a>.</p>
  </div>
</form>
