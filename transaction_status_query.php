...
/* YOU WILLL NOTICE I AM USING LIVE URLS FROM SAFARICOM HERE. if YOU ARE RUNNING ON SANDBOX CHANGE THE QUERY URLS FROM HTTPS://API.SAFARICOM..... TO THE ONES ON SANDBOX */
  /*FOR LIVE REMEMBER SECURITY CREDENTIAL IS THE ENCRYPTED PASSWORD FOR LOGGING INTO MPESA PORTAL. Encrypt using safaricom developers website account on "create credentials" */
  /* access token */
